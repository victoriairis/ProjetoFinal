...
public class SyncMain {
    ...
    private final String databaseName = "projetointegrado";
    private final String containerName = "dadospeers";
    ...
    private void getStartedDemo() throws Exception {
        ...
        defaultPolicy.setPreferredRegions(Lists.newArrayList("Brazil South"));
